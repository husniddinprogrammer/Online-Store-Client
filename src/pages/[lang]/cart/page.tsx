...
import { useMe, useAddresses, useCreateOrder } from '@/hooks/useProfile'
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 pointer-events-none">
            ...
            >
              ...
              <div className="px-6 py-5 flex flex-col gap-5">
                {/* Balance info */}
                <div
                  className={`rounded-xl p-4 flex flex-col gap-2 ${canAfford ? 'bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800' : 'bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800'}`}
                >
                  <div className="flex justify-between text-sm">
                    <span className="text-gray-600 dark:text-gray-400">Balans</span>
                    <span className="font-semibold text-gray-900 dark:text-gray-100">
                      {formatUZS(balance, lang)}
                    </span>
                  </div>
                  <div className="flex justify-between text-sm">
                  ...
                  <div className="border-t border-gray-200 dark:border-gray-700 pt-2 flex justify-between text-sm font-bold">
                    ...
                    >
                      {formatUZS(Math.abs(remaining), lang)}
                    </span>
                  </div>
                </div>
                  ...
                  <div className="flex items-start gap-3 p-4 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-xl">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-red-600 dark:text-red-500 mt-0.5">
                        Buyurtma berish uchun balansni{' '}
                        <Link
                        ...
                        {addresses.map((addr) => (
                          ...
                          >
                            ...
                            <span className="text-sm text-gray-800 dark:text-gray-200">
                              {addr.regionType}, {addr.cityType}, {addr.homeNumber}-uy,{' '}
                              {addr.roomNumber}-xona
                            </span>
                          </label>
                        ))}
                      </div>
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center gap-2 mt-1">
                      <span className="text-sm font-bold text-blue-600">
                        {formatUZS(item.discountedPrice || item.price, lang)}
                      </span>
                      {item.discountPercent > 0 && (
                        <span className="text-xs text-gray-400 line-through">
                          {formatUZS(item.price, lang)}
                        </span>
                      )}
                    </div>
                    ...
                    <div className="flex items-center gap-3 mt-2">
                      ...
                      <span className="text-sm font-semibold text-gray-700 dark:text-gray-300">
                        {formatUZS(item.totalPrice, lang)}
                      </span>
                    </div>
                  </div>
              ...
              <div className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 p-6 shadow-sm sticky top-20 flex flex-col gap-4">
                ...
                <div className="flex flex-col gap-3">
                  ...
                  <div className="border-t border-gray-200 dark:border-gray-700 pt-3 flex justify-between font-bold text-gray-900 dark:text-gray-100">
                    ...
                    <span className="text-blue-600">{formatUZS(totalAmount, lang)}</span>
                  </div>
                </div>
                ...
                {isLoggedIn && me && (
                  ...
                  >
                    <span>Balans</span>
                    <span className="font-semibold">{formatUZS(balance, lang)}</span>
                  </div>
                )}
