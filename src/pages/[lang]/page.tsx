...
import { usePosters, useProducts, useCategoriesWithProducts } from '@/hooks/useProducts'
...
function HomeContent({ lang, dict }: { lang: string; dict: Dictionary }) {
  ...
  const { data: categoriesData, isLoading: catsLoading } = useCategoriesWithProducts({
    size: 20,
  })
