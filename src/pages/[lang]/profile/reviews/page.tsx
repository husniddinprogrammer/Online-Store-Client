...
import { useMyReviews, usePendingReviews } from '@/hooks/useProfile'
import { useProduct } from '@/hooks/useProducts'
import { img } from '@/utils/img'
import { StarRating } from '@/components/ui/StarRating'
import { ReviewModal } from '@/components/profile/ReviewModal'
import { getDictionary, type Locale, type Dictionary } from '@/i18n'
import type { CommentResponse, ProductResponse } from '@/services/api/types'
...
export default function ReviewsPage({ params }: PageProps) {
  ...
  const [reviewTarget, setReviewTarget] = useState<{ id: number; name: string } | null>(
    null
  )
