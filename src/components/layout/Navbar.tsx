                ...
                <div className="grid grid-cols-4 gap-2">
                  {filteredCategories.map((cat) => (
                    ...
                    >
                      ...
                      <span className="text-xs font-medium text-slate-600 dark:text-slate-400 group-hover:text-blue-600 dark:group-hover:text-blue-400 line-clamp-2 transition-colors">
                        {cat.name}
                      </span>
                    </Link>
                  ))}
