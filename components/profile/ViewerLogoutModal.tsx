...
const modalTexts = {
  en: {
    ...
    message: 'Viewer role users cannot access profile pages. You have been automatically logged out for security reasons.',
    buttonText: 'Go to Homepage'
  },
  ru: {
    title: 'Доступ ограничен',
    message: 'Пользователи с ролью Viewer не могут получить доступ к страницам профиля. Вы были автоматически вышли из системы по соображениям безопасности.',
    buttonText: 'Перейти на главную'
  },
  uz: {
    title: 'Kirish cheklandi',
    message: 'Viewer roldagi foydalanuvchilar profil sahifalariga kira olmaydi. Xavfsizlik sabablariga ko\'ra siz avtomatik ravishda tizimdan chiqarildingiz.',
    buttonText: 'Asosiy sahifaga o\'tish'
  },
  kr: {
    title: 'Кириш чекланган',
    message: 'Viewer ролидаги фойдаланувчилар профиль саҳифаларига кира олмайди. Хавфсизлик сабабларига кўра сиз автоматик равишда тизимдан чиқарилдингиз.',
    buttonText: 'Асосий саҳифага ўтиш'
  }
}

export function ViewerLogoutModal({
  open,
  onClose,
  dictionary,
  lang,
}: ViewerLogoutModalProps) {
