...
import { useProduct, useProducts, useComments } from '@/lib/hooks/useProducts'
    ...
    <>
      ...
      <main className="flex-1 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <nav className="flex items-center gap-2 text-sm text-gray-500 dark:text-gray-400 mb-6">
          ...
          <span className="text-gray-800 dark:text-gray-200 line-clamp-1">{product.name}</span>
        </nav>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-10">
          ...
          <div className="lg:col-span-1 flex flex-col gap-3">
            {/* Main image */}
            <div className="relative rounded-2xl overflow-hidden bg-gray-100 dark:bg-gray-800" style={{ aspectRatio: '1/1' }}>
              {mainImageUrl ? (
                <Image
                  src={mainImageUrl}
                  alt={product.name}
