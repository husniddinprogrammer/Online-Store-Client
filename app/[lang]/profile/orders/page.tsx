...
function EmptyOrders({ dict }: { dict: Dictionary }) {
  return (
    <div className="flex flex-col items-center justify-center py-16 text-center">
      <svg className="w-20 h-20 text-gray-200 dark:text-gray-700 mb-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1}>
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b border-gray-100 dark:border-gray-700 bg-gray-50 dark:bg-gray-700/40">
                    <th className="text-left px-4 py-3 font-semibold text-gray-600 dark:text-gray-300">{dict.profile.orderId}</th>
                    <th className="text-left px-4 py-3 font-semibold text-gray-600 dark:text-gray-300">{dict.profile.orderDate}</th>
                    <th className="text-left px-4 py-3 font-semibold text-gray-600 dark:text-gray-300">{dict.profile.orderStatusCol}</th>
                    <th className="text-left px-4 py-3 font-semibold text-gray-600 dark:text-gray-300">Items</th>
                    <th className="text-left px-4 py-3 font-semibold text-gray-600 dark:text-gray-300">{dict.profile.orderTotal}</th>
